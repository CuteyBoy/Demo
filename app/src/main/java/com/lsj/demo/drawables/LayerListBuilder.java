...
public class LayerListBuilder implements DrawableBuilder {
    ...
    public static class LayerInset {
        ...
        public LayerInset padding(int left, int top, int right, int bottom) {
            this.left = (int) (left * CxtUtils.getDensity() + .5f);
            this.top = (int) (top * CxtUtils.getDensity() + .5f);
            this.right = (int) (right * CxtUtils.getDensity() + .5f);
            this.bottom = (int) (bottom * CxtUtils.getDensity() + .5f);
            return this;
        }

        public LayerInset padding(int padding) {
            padding = (int) (padding * CxtUtils.getDensity() + .5f);
            this.left = padding;
            this.top = padding;
            this.right = padding;
            this.bottom = padding;
        ...
        public LayerInset width(int width) {
            this.width = (int) (width * CxtUtils.getDensity() + .5f);
            return this;
        }

        @TargetApi(Build.VERSION_CODES.M)
        public LayerInset height(int height) {
            this.height = (int) (height * CxtUtils.getDensity() + .5f);
            return this;
        }
